...
"use strict";var aff_id=$('meta[name="aff_id"]').attr("content");$(window).resize((function(o){void 0!==window.orientation?($(".btnplayweb, .slogan, .mainform").hide(),$(".maindlapp, .showtext-mb").addClass("active"),$("#huongdan").show()):($(".btnplayweb, .slogan, .mainform").show(),$(".maindlapp, .showtext-mb").removeClass("active"),$("#huongdan").hide())})),$(document).ready((function(){void 0!==window.orientation?($(".btnplayweb, .slogan, .mainform").hide(),$(".maindlapp, .showtext-mb").addClass("active"),$("#huongdan").show()):($(".btnplayweb, .slogan, .mainform").show(),$(".maindlapp, .showtext-mb").removeClass("active"),$("#huongdan").hide()),setCookiesLogIpv4(),setCookiesLogIpv6()}));var setCookiesLogIpv4=function(){$.ajax({url:"https://api4."+conf.logip+"/sw/collect?aff_id="+aff_id,dataType:"json",success:function(o,a){},error:function(o,a,n){}})},setCookiesLogIpv6=function(){$.ajax({url:"https://api6."+conf.logip+"/sw/collect?aff_id="+aff_id,dataType:"json",success:function(o,a){},error:function(o,a,n){}})};